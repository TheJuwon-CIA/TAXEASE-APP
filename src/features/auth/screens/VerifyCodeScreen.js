    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <AppText style={styles.subtitle}>
          We've sent a 6-digit verification code to your email address (e.g. {maskedEmail}). Please enter it below.
        </AppText>
        <View style={styles.otpWrap}>
          <OTPInput length={6} onComplete={setOtp} />
        </View>
        <Button title="Verify Code" onPress={handleVerify} loading={loading} style={styles.btn} />
...
const styles = StyleSheet.create({
  ...
  iconCircle: { width: 100, height: 100, borderRadius: 50, borderWidth: 2.5, borderColor: COLORS.primaryLight, alignItems: 'center', justifyContent: 'center', marginBottom: SPACING.lg },
  title: { fontSize: FONTS.sizes.xxxl, fontWeight: '800', color: COLORS.primaryLight, marginBottom: SPACING.md, textAlign: 'center' },
