...
const styles = StyleSheet.create({
  ...
  standardBtn: { alignSelf: 'flex-end', backgroundColor: '#078E18', borderRadius: RADIUS.sm, paddingHorizontal: SPACING.lg, paddingVertical: SPACING.sm, marginBottom: SPACING.lg },
  standardText: { color: COLORS.white, fontSize: FONTS.sizes.lg, fontWeight: '700' },
  continueBtn: { alignSelf: 'center', width: '78%', backgroundColor: '#078E18', borderRadius: RADIUS.md, paddingVertical: SPACING.lg, alignItems: 'center', marginTop: SPACING.xl },
  continueText: { color: COLORS.white, fontSize: 36, fontWeight: '700' },
  ...
  helpLink: { textAlign: 'center', fontSize: FONTS.sizes.lg, color: '#078E18', fontWeight: '700' },
  ...
  activeRow: { backgroundColor: '#078E18' },
  activeText: { color: COLORS.white, fontWeight: '900' },
  note: { fontSize: 26, lineHeight: 35, color: '#253041', marginBottom: SPACING.xl },
  ...
  summaryTitle: { fontSize: 34, fontWeight: '900', marginTop: SPACING.xxxl, marginBottom: SPACING.md },
  ...
  savedTitle: { fontSize: 32, fontWeight: '900', marginBottom: SPACING.md },
  ...
  saveProfile: { fontSize: 24, fontWeight: '800', color: '#078E18' },
});
