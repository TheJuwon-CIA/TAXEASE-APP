...
const styles = StyleSheet.create({
  ...
  avatar: { width: 120, height: 120, borderRadius: 60, backgroundColor: '#078E18', alignItems: 'center', justifyContent: 'center', marginBottom: SPACING.md },
  name: { fontSize: 34, fontWeight: '900', color: '#253041' },
  email: { fontSize: FONTS.sizes.sm, color: COLORS.textDark, marginVertical: SPACING.md },
  editBtn: { borderWidth: 2, borderColor: '#078E18', borderRadius: RADIUS.full, paddingHorizontal: SPACING.xl, paddingVertical: SPACING.sm },
  editText: { color: '#078E18', fontSize: FONTS.sizes.lg, fontWeight: '800' },
